...
public final class AnimationUtils
{
    ...
    {
        RotateAnimation rotateAnimation = getRotateAnimationByCenter(1000, null);
    ...
    public static AlphaAnimation getAlphaAnimation (float fromAlpha, float toAlpha,
                                                    long durationMillis, long startOffTime,
                                                    AnimationListener animationListener)
    {
        AlphaAnimation alphaAnimation = new AlphaAnimation(fromAlpha, toAlpha);
        alphaAnimation.setDuration(durationMillis);
        alphaAnimation.setRepeatCount(Animation.INFINITE);
        alphaAnimation.setStartOffset(startOffTime);
        if (animationListener != null)
        {
    ...
    public static AlphaAnimation getAlphaAnimation (float fromAlpha, float toAlpha,
                                                    long durationMillis, long startOffTime)
    {
        return getAlphaAnimation(fromAlpha, toAlpha, durationMillis, startOffTime, null);
    }
    ...
    public static AlphaAnimation getAlphaAnimation (float fromAlpha, float toAlpha,
                                                    AnimationListener animationListener)
    {
        return getAlphaAnimation(fromAlpha, toAlpha, DEFAULT_ANIMATION_DURATION, 0, animationListener);
    }
    ...
    public static AlphaAnimation getAlphaAnimation (float fromAlpha, float toAlpha)
    {
        return getAlphaAnimation(fromAlpha, toAlpha, DEFAULT_ANIMATION_DURATION, 0, null);
    }
    ...
    public static AlphaAnimation getHiddenAlphaAnimation (long durationMillis,
                                                          AnimationListener animationListener)
    {
        return getAlphaAnimation(1.0f, 0.0f, durationMillis, 0, animationListener);
    }
    ...
    public static AlphaAnimation getShowAlphaAnimation (long durationMillis,
                                                        AnimationListener animationListener)
    {
        return getAlphaAnimation(0.0f, 1.0f, durationMillis, 0, animationListener);
    }
    ...
    public static AlphaAnimation getShowAlphaAnimation (long durationMillis)
    {
        return getAlphaAnimation(0.0f, 1.0f, durationMillis, 0, null);
    }
    ...
    {
        return getAlphaAnimation(0.0f, 1.0f, DEFAULT_ANIMATION_DURATION, 0, animationListener);
    }
    ...
    {
        return getAlphaAnimation(0.0f, 1.0f, DEFAULT_ANIMATION_DURATION, 0, null);
    }
     ...
     * @param isBanClick     在执行动画的过程中是否禁止点击
     */
    public static void shake (View view, float fromXDelta, float toXDelta, float cycles,
                              long durationMillis, final boolean isBanClick)
    {
